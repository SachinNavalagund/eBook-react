...
import { formatPrice, parserError } from "../utils/helper";
...
const Orders: FC<Props> = () => {
  ...
  if (pending) return <OrdersSkeleton />;
          ...
          <div key={order.id}>
                ...
                <div key={product.id}>
                  <div className="flex p-5">
                    <img
                      src={product.cover}
                      alt={product.title}
                      className="w-24 h-[150px] rounded"
                    />
            ...
            <div className="text-right space-y-1 py-6">
              <p className="font-semibold text-xl">
                Total Amount: {formatPrice(Number(order.totalAmount) / 100)}
              </p>
